 ...
 */
@UtilityClass
public class MaxAnnualFinancingRateForFinancingTermCalculator {

    public static MaxAnnualFinancingRateForFinancingTerm calculateMaxAnnualFinancingRateForFinancingTermInBps(
            int creditorMaxFinancingRateInBps, FinancingTerm financingTerm) {
        return new MaxAnnualFinancingRateForFinancingTerm(
                (creditorMaxFinancingRateInBps * 360) / financingTerm.termInDays());
    }
}
