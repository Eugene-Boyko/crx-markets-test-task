...
public class InvoiceController {
    ...
    public ResponseEntity<Void> processInvoices(@RequestBody @Valid ProcessInvoiceRequest request) {
        log.trace("InvoiceController: processInvoices, requested dateForProcessing: {}", request.date());

        invoiceProcess.processInvoices(request.date());

        log.trace("InvoiceController: processInvoices finished, dateForProcessing: {}", request.date());
